...
<div class="layui-header header header-store" style="background-color: #393D49;">
    <div class="layui-container">
        <a class="logo" href="../backstage.jsp">
        ...
        <ul class="layui-nav" id="layui-nav-userinfo">
            ...
            <li data-id="room" class="layui-nav-item layui-hide-xs layui-this"><a class="fly-case-active"
                                                                                  data-type="toTopNav"
                                                                                  href="${pageContext.request.contextPath}/room/list.html">房间</a></li>
...
<div class="layui-container shopdata">
    <div class="layui-card shopdata-intro">
        <div class="layui-card-header">
				...
				<a href="/index.html">酒店首页</a><span lay-separator="">/</span>
                ...
                <div class="intro-txt">
                    ...
                    <div class="store-attrs">
                        <div class="summary">
                            ...
                            <p class="reference"><span>宽　带</span> <span id="broadband">免费wifi,100G网速</span></p>
