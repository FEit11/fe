...
<head>
    ...
    <link rel="icon" href="${pageContext.request.contextPath}/statics/front/images/wly.jpg">
    <title>酒店管理系统</title>
<body>
<!-- 顶部start -->
<div class="layui-header header header-store" style="background-color: #393D49;">
    <div class="layui-container">
        <a class="logo" href="${pageContext.request.contextPath}/backstage.jsp">
...
<div class="shoplist-filter">
    <div class="layui-container">
        <div class="layui-card">
            <div class="layui-card-header"> <span class="layui-breadcrumb" style="visibility: visible;"> <a href="/index.html">酒店首页</a><span lay-separator="">/</span> <a href="../hotel/lists.html">类别</a><span lay-separator="">/</span> <a><cite>全部</cite></a>
						</span> </div>
...
<div class="fly-footer">
    ...
    <p>
        友情链接
        <a href="http://www.yeidea.top/" target="_blank">阿文博客</a>
        <a href="https://www.baidu.com/" target="_blank">百度</a>
        <a href="https://www.taobao.com/" target="_blank">淘宝</a>
        <a href="https://www.aliyun.com/" target="_blank">阿里云</a>
        <a href="https://cloud.tencent.com/" target="_blank">腾讯云</a> </p>
    <a href="http://beian.miit.gov.cn/">粤ICP备2021161416号-1</a>
</div>
